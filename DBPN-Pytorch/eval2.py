...
parser.add_argument('--input_dir', type=str, default='./dataset/결과/bicubic2x4xgt')
parser.add_argument('--output', default='./Result', help='Location to save checkpoint models')
parser.add_argument('--test_dataset', type=str, default='4x')
...
parser.add_argument('--model', default='C:/Users/LG/Desktop/융캡/10.16 모델링4가지 성능/PyTorch-20201015T092947Z-001/PyTorch/DBPN_x4.pth', help='sr pretrained base model')
