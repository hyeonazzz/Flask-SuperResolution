...
def train(args):
    ...
    while pre_epoch < args.pre_train_epoch:
        ...
        if pre_epoch % 800 ==0:
            torch.save(generator.state_dict(), 'C:/Users/jihun/SRGAN-PyTorch/model/pre_trained_model_%03d.pt'%pre_epoch)
    ...
    while fine_epoch < args.fine_train_epoch:
        ...
        if fine_epoch % 500 ==0:
            torch.save(generator.state_dict(), 'C:/Users/jihun/SRGAN-PyTorch/model/SRGAN_gene_%03d.pt'%fine_epoch)
            torch.save(discriminator.state_dict(), 'C:/Users/jihun/SRGAN-PyTorch/model/SRGAN_discrim_%03d.pt'%fine_epoch)
